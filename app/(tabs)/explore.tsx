...
const styles = StyleSheet.create({
  container: { flex: 1 },
  subtitle: { fontSize: normalizeFont(16), color: '#CCCCCC' },
  logoLiving: { fontSize: normalizeFont(32), fontWeight: 'bold', color: '#D4AF37', textTransform: 'uppercase' },
  logoContainer: { flexDirection: 'row', alignItems: 'center', marginBottom: 0 },
  loadingText: { marginTop: normalize(10), fontSize: normalizeFont(16), color: '#666' },
  headerBlack: {
  ...
  logoOdihna: { fontSize: normalizeFont(32), fontWeight: 'bold', color: '#FFFFFF', textTransform: 'uppercase' },
  ...
  searchInput: { flex: 1, fontSize: normalizeFont(16), color: '#000' },
  dateRow: { flexDirection: 'row', gap: normalize(10), marginBottom: normalize(15) },
  dateInput: { flex: 1, backgroundColor: '#fff', borderRadius: normalize(12), padding: normalize(12) },
  dateInputContent: { flexDirection: 'row', alignItems: 'center', gap: normalize(10) },
  dateTextContainer: { flex: 1 },
  dateLabel: { fontSize: normalizeFont(12), color: '#666', marginBottom: normalize(2) },
  dateValue: { fontSize: normalizeFont(14), fontWeight: '600', color: '#000' },
  guestsButton: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: '#fff',
  ...
  guestsLabel: { fontSize: normalizeFont(12), color: '#666', marginBottom: normalize(2) },
  guestsValue: { fontSize: normalizeFont(14), fontWeight: '600', color: '#000' },
  searchButtonRow: { flexDirection: 'row', gap: normalize(10) },
  searchButton: {
    flex: 1,
    flexDirection: 'row',
    alignItems: 'center',
  ...
  searchButtonText: { color: '#fff', fontSize: normalizeFont(16), fontWeight: 'bold' },
  clearButton: {
    width: normalize(50),
    backgroundColor: '#fff',
    borderRadius: normalize(12),
  ...
  activeSearchText: { fontSize: normalizeFont(13), color: '#D4AF37', fontWeight: '600' },
  categoriesSection: { paddingVertical: normalize(20) },
  categoriesScroll: { paddingHorizontal: normalize(20), gap: normalize(12) },
  categoryCard: {
    alignItems: 'center',
    justifyContent: 'center',
    paddingVertical: normalize(12),
  ...
  categoryText: { marginTop: normalize(6), fontSize: normalizeFont(12), fontWeight: '600', color: '#333', textAlign: 'center' },
  categoryTextActive: { color: '#fff' },
  propertiesSection: { paddingHorizontal: normalize(20), paddingBottom: normalize(20) },
  sectionTitle: { fontSize: normalizeFont(22), fontWeight: 'bold', marginBottom: normalize(15) },
  emptyState: { alignItems: 'center', justifyContent: 'center', paddingVertical: normalize(60) },
  emptyStateText: { fontSize: normalizeFont(18), color: '#999', marginTop: normalize(20), fontWeight: '600' },
  emptyStateSubtext: { fontSize: normalizeFont(14), color: '#999', marginTop: normalize(8), textAlign: 'center' },
  propertyCard: {
    backgroundColor: '#fff',
  ...
  propertyImage: { width: '100%', height: normalize(220) },
  propertyInfo: { padding: normalize(15) },
  propertyTitle: { fontSize: normalizeFont(18), fontWeight: 'bold', marginBottom: normalize(8) },
  propertyLocation: { flexDirection: 'row', alignItems: 'center', gap: normalize(5), marginBottom: normalize(12) },
  locationText: { fontSize: normalizeFont(14), color: '#666' },
  propertyFooter: {
    flexDirection: 'row',
  ...
  price: { fontSize: normalizeFont(20), fontWeight: 'bold', color: '#2C5F7C' },
  priceLabel: { fontSize: normalizeFont(14), color: '#666' },
  ratingContainer: { flexDirection: 'row', alignItems: 'center', gap: normalize(4) },
  rating: { fontSize: normalizeFont(14), fontWeight: 'bold' },
  reviewCount: { fontSize: normalizeFont(14), color: '#666' },
  bottomSpacing: { height: normalize(30) },
  modalOverlay: {
    flex: 1,
  ...
  counterSection: { padding: normalize(20) },
  counterRow: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
  ...
  counterLabel: { fontSize: normalizeFont(16), fontWeight: '600' },
  counterSubLabel: { fontSize: normalizeFont(14), color: '#666', marginTop: normalize(2) },
  counterControls: { flexDirection: 'row', alignItems: 'center', gap: normalize(15) },
  counterButton: {
    width: normalize(36),
    height: normalize(36),
  ...
  counterValue: { fontSize: normalizeFont(18), fontWeight: 'bold', minWidth: normalize(30), textAlign: 'center' },
  modalApplyButton: {
  ...
  modalApplyButtonText: { color: '#fff', fontSize: normalizeFont(16), fontWeight: 'bold' },
});
