...
const styles = StyleSheet.create({
  ...
  keyboardView: { flex: 1 },
  scrollContent: { flexGrow: 1, justifyContent: 'center', padding: normalize(24), paddingTop: normalize(100) },
  content: { flex: 1, justifyContent: 'center' },
  header: { marginBottom: normalize(32) },
  ...
  roleWrapper: { gap: normalize(12) },
  roleContainer: { flexDirection: 'row', gap: normalize(12) },
  roleButton: {
    flex: 1,
    flexDirection: 'row',
    alignItems: 'center',
  ...
  roleText: { color: '#9CA3AF', fontSize: normalizeFont(15), fontWeight: '600' },
  ...
  footer: { flexDirection: 'row', justifyContent: 'center', marginTop: normalize(24) },
