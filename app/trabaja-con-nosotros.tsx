...
export default function TrabajaConNosotrosScreen() {
    ...
    <ThemedView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerTitleContainer}>
          <ThemedText style={styles.headerTitle}>Únete al Equipo</ThemedText>
          <ThemedText style={styles.headerSubtitle}>Oportunidades</ThemedText>
        </View>
      </View>
      ...
      >
        <View style={[styles.iconContainer, { backgroundColor: isDark ? colors.cardBackground : '#fff' }]}>
          ...
          >
            <Ionicons name="briefcase-outline" size={50} color="#FFF" />
          </LinearGradient>
        </View>
        ...
        <ThemedText style={[styles.subtitle, { color: colors.textSecondary }]}>
          Forma parte de nuestro equipo y ayúdanos a crear experiencias únicas para nuestros huéspedes
        </ThemedText>
